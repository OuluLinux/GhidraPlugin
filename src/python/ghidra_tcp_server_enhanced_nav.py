"""
Enhanced Ghidra TCP Server with Navigation Features

This script provides a TCP server with bookmark management, note-taking,
and enhanced navigation capabilities for Ghidra client communication.
"""
...
class GhidraTCPClientHandler:
    ...
    def __init__(self, connection_socket, current_program, current_location=None):
        ...
        self.running = True
        # Initialize persistent storage for bookmarks and notes
