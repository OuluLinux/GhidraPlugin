"""
Enhanced Ghidra TCP Server with Structure and Enum Management

This script provides a TCP server with structure and enum management capabilities
...
class GhidraTCPClientHandler:
    ...
    def handle_command(self, command, parameters):
        ...
        command_handlers = {
            ...
            # New Structure and Enum Management Features (Phase 2)
...
Available commands:
  ...
  DECOMPILE <func_name>             - Decomile function to source code
